...
class TwoNoteNeuralNet:
    ...
    def __init__(self,
        ...
        self.wav_file_name = 'generatedMusic.wav'
        self.model_save_h5 = 'NoteMusic.h5'
        self.weights_save_h5 = 'NoteMusicWeights.h5'
        self.model_save_json = 'NoteMusic.json'
        self.set_up_model()
    ...
    def get_training_data(self):
        ...
        parser = NoteParser(note_file.read(), self.number_of_previous_notes)
